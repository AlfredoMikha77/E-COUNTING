...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="../penyedia/penyedia.php" class="active">
                    <i></i>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <div class="form-login">
                <form action="penyedia-proses.php" method="post" enctype="multipart/form-data">
                    ...
                    <img src="../img_penyedia/<?= $data['photo'] ?>" alt="" width="200px">
