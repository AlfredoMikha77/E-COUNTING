    ...
    <section class="home-section">
        ...
        <div class="home-content">
            <button type="button" class="btn btn-tambah">
                <a href="penyedia-entry.php">Tambah Data</a>
            </button>
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        echo "
                            <tr>
                                <td>
                                    <img src='../img_penyedia/$data[photo]' width='200px'>
                                </td>
                                <td>$data[nama]</td>
                                ...
                                <td>
                                    <div class='action-buttons'>
                                        <a class='btn-edit' href='penyedia-edit.php?id=$data[id]'>Edit</a>
                                        <a class='btn-delete' href='penyedia-hapus.php?id=$data[id]'>Hapus</a>
                                    </div>
                                </td>
                            </tr>
                        ";
